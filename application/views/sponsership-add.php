<!-- Right side column. Contains the navbar and content of the page -->
           <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>
                       Add New  Sponsership Type
                    </h1>
                    <ol class="breadcrumb">
                        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
                        
                        <li class="active">Add New  Sponsership Type</li>
                    </ol>
                </section>
...
$(document).ready(function (e) {
	...
	$(document).on("keyup", "#name", function () {
		...
		$.ajax({
        	url: "<?php echo base_url()?>Sponsershiptype/checkExists",
			type: "POST",
	...
	$("#uploadForm").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
        	url: "<?php echo base_url()?>Sponsershiptype/save",
			type: "POST",
			...
			else
			{
				$("#error").hide();
				$('#error').html('');
				location.href= '<?php echo base_url()?>Sponsershiptype';
			}
			},
		  	error: function() 
	    	{
