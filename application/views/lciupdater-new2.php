<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Tender Order - LCI Report Update</h1>
      <ol class="breadcrumb">
    ...
    <section class="content">
      ...
      <form action="<?php echo base_url()?>Lcireportupdate/save" method="post" enctype="multipart/form-data">
...
?>
<select name="financial_year" required disabled  class="form-control">
			 ...
			 /* if(!empty($_SESSION['district']))
			  ...
			  $totalInvoices = mysql_query("SELECT * FROM tenders_details WHERE financial_year <> ''  ORDER BY id DESC");
							...
							*/
							 ...
							 $sql = "select * from ( SELECT a.*,b.vehicle_category FROM tenders_details_new_details a LEFT JOIN vehicle_category_masters  b on a.item_id=b.id WHERE a.item_cat='Vehicle'  and a.tenders_details_new_id ='".$fetch222['id']."' ";
							 
							 $sql .= " UNION ";
							 $sql .= "SELECT a.*,b.logistics_name as vehicle_category  FROM tenders_details_new_details a LEFT JOIN logistics_kits_masters  b on a.item_id=b.id WHERE a.item_cat='Logistics'  and a.tenders_details_new_id ='".$fetch222['id']."'  ) as tmp ORDER BY id DESC";
...
<div class="form-group row">
				  ...
				  Purpose
				    ...
				    <input readonly  type="text" class="form-control" placeholder="Purpose " value="<?php echo $fetch222['purpose']; ?>" name="purpose">
				   ...
				   Purchase From
				    ...
				    <input readonly type="text" class="form-control" placeholder="Purchase From " value="<?php echo $fetch222['purchase_from']; ?>" name="purchase_from">
				  ...
				  LCI Officer 1
					...
					<select readonly  class="form-control show-tick" name="lci_officer_1" id="lci_officer_1">  
...
$sql = "SELECT * FROM logistics_licofficers_masters";
				   ...
				   LCI Officer 2
					...
					<select readonly class="form-control show-tick" name="lci_officer_2" id="lci_officer_2">  
				  ...
				  LCI Officer 3
					...
					<select  readonly class="form-control show-tick" name="lci_officer_3" id="lci_officer_3">  
				 ...
				 Head of Account
					...
					<input readonly  type="text" class="form-control" placeholder=" Head of Account" value="<?php echo $fetch222['head_of_account']; ?>" name="head_of_account">
				  </div>
				  
				  
				     <label for="example-search-input" class="col-sm-4 col-form-label">Upload LCI Report</label>
				  <div class="col-sm-6">
			<input type="file" class="form-control" placeholder=" " value="" name="lci_report">
				  </div>   
