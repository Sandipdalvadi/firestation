           ...
           <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Add Treasurer</li>
                    </ol>
                </section>
                        ...
                        <div class="col-xs-6">
							 ...
							 <div class="box">
							  ...
							  <form role="form" method="post" name="uploadForm" id="uploadForm">
									...
									<input type="hidden"  value="Treasurer" name="role" id="role"  >
...
$(document).ready(function (e) {
	...
	$(document).on("keyup", "#email", function () {
		...
		$.ajax({
        	url: "<?php echo base_url()?>Treasurer/checkExists",
			type: "POST",
	...
	$("#uploadForm").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
        	url: "<?php echo base_url()?>Treasurer/save",
			type: "POST",
			...
			else
			{
				$("#error").hide();
				$('#error').html('');
				location.href= '<?php echo base_url()?>Treasurer';
			}
			},
		  	error: function() 
	    	{
