							  ...
							  <form role="form" method="post" name="uploadForm" id="uploadForm">
									...
									?>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $data['coupon_code']?>"  name="coupon_code" id="coupon_code"  required>
										...
										<div class="form-group">
                                            ...
                                            <input type="text" onkeypress="return isNumberKey(event)" class="form-control" value="<?php echo $data['discount_value']?>"  name="discount_value" id="discount_value"  required>
								...
								<div class="form-group">
											...
											<option value="PERCENTAGE" <?php if($data['discount_mode'] == "PERCENTAGE") echo "selected";?>>Percentage</option>
											<option value="USD" <?php if($data['discount_mode'] == "USD") echo "selected";?>>USD</option>
											</select>
                                        </div>
...
jqry(document).ready(function (e) {
	...
	$(document).on("keyup", "#coupon_code", function () {
		...
		$.ajax({
        	url: "<?php echo base_url()?>Specialoffers/checkcouponcodeedit",
			type: "POST",
	...
	$("#uploadForm").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
        	url: "<?php echo base_url()?>Specialoffers/update",
			type: "POST",
