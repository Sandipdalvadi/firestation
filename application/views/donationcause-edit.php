           ...
           <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Donation Cause</li>
                    </ol>
                </section>
							  ...
							  <form role="form" method="post" name="uploadForm" id="uploadForm">
                                    <div class="box-body">
									 ...
									 <div class="form-group">
                                            ...
                                            <input type="text"   onkeypress="return isNumberKey(event)" class="form-control" value="<?php echo $data['amount']?>" name="amount" id="amount"  required>
											<div class="alert alert-danger alert-dismissable" id="error" style="display:none;margin:0px"></div>
                                        </div>
...
$(document).ready(function (e) {
	...
	$(document).on("keyup", "#name", function () {
		...
		$.ajax({
        	url: "<?php echo base_url()?>Donationcause/checkcountryedit",
			type: "POST",
	...
	$("#uploadForm").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
        	url: "<?php echo base_url()?>Donationcause/update",
			type: "POST",
