  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Rank <small>masters </small> </h1>
      <ol class="breadcrumb">
  ...
  <div class="row">
	 ...
	 <div class="box-body"><table id="examplecom" class="table table-bordered table-hover display nowrap table-responsive" >
            ...
            <tbody>
              ...
              <tr>
			   ...
			   <td><!--<a href="?id=<?php echo $row['id']; ?>&Action=Edit"><img src="icon-edit.png" height="20"></a> | --><a class="deletemecommon" href="<?php echo base_url()?>Ranks/delete/<?php echo $row['id']; ?>"><img src="<?php echo base_url()?>assets/img/deleteicon.png" height="20"></a></td>
	...
	<form action="<?php echo base_url()?>Ranks/save" method="post" enctype="multipart/form-data">
            	
				<div class="form-group row">&nbsp;</div>
				<div class="form-group row">
				  <label for="example-search-input" class="col-sm-4 col-form-label">Rank</label>
				  <div class="col-sm-6">
					<input type="text" class="form-control" placeholder="Rank" value="" required name="name">
				  </div>
