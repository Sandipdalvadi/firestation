<!-- Content Wrapper. Contains page content -->
  ...
  <div class="row">
    ...
    <div class="col-sm-12" style="background-color:#d8e1f0;">
        ...
        <form action="<?php echo base_url()?>Recivestockbytendernew/index2" method="post" enctype="multipart/form-data">
			  ...
			  <div class="form-group row">
				  ...
				  Tender Number
					...
					$sql = "SELECT id, tender_number FROM tenders_details_new where status='initiated' order by id desc ";
