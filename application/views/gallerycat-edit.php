           ...
           <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Edit Gallery Category</li>
                    </ol>
                </section>
...
$(document).ready(function (e) {
	...
	$(document).on("keyup", "#title", function () {
		...
		$.ajax({
        	url: "<?php echo base_url()?>Gallertcat/checkcountryedit",
			type: "POST",
	...
	$("#uploadForm").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
        	url: "<?php echo base_url()?>Gallertcat/update",
			type: "POST",
			...
			else
			{
				$("#error").hide();
				$('#error').html('');
				location.href= '<?php echo base_url()?>Gallertcat';
			}
			},
		  	error: function() 
	    	{
