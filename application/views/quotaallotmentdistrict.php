 <!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Quoata Allotment  - District </h1>
      <ol class="breadcrumb">
  ...
  <div class="row">
            ...
            <tbody>
			  ...
			  /*$totalInvoices = mysql_query("SELECT * FROM fuel_quota_allotments WHERE district = '' ORDER BY id DESC");
				   ...
				   $count = 0;
					...
					$sql = "SELECT a.*,b.unit_name as districtsss FROM fuel_quota_allotments a LEFT JOIN units_masters b on a.district=b.id  WHERE a.district IS NOT NULL AND a.allotments_type IS NULL ORDER BY a.id DESC";
              ...
              <tr>
			   ...
			   <td><a href="<?php echo base_url()?>Quotaallotmentdistrict/index/<?php echo $row['id']; ?>"><img src="<?php echo base_url()?>assets/img/icon-edit.png" height="20"></a></td>
    ...
    <div class="col-sm-6" style="background-color:#d8e1f0;"><form action="<?php echo base_url()?>Quotaallotmentdistrict/save" method="post" enctype="multipart/form-data">
