  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1> Logistics Category <small>masters </small> </h1>
      <ol class="breadcrumb">
  ...
  <div class="row">
	 ...
	 <div class="box-body"><table id="examplecom" class="table table-bordered table-hover display nowrap table-responsive" >
            ...
            <tbody>
              ...
              <tr>
                ...
                <td><?php echo $row['logistics_category']; ?></td>
			   ...
			   <td><!--<a href="?id=<?php echo $row['id']; ?>&Action=Edit"><img src="icon-edit.png" height="20"></a> | --><a class="deletemecommon" href="<?php echo base_url()?>Lcategory/delete/<?php echo $row['id']; ?>"><img src="<?php echo base_url()?>assets/img/deleteicon.png" height="20"></a></td>
	...
	<form action="<?php echo base_url()?>Lcategory/save" method="post" enctype="multipart/form-data">
            	
				<div class="form-group row">&nbsp;</div>
				<div class="form-group row">
				  <label for="example-search-input" class="col-sm-4 col-form-label">Logistics Category</label>
				  <div class="col-sm-6">
					<input required  type="text" class="form-control" placeholder="Logistics Category" value="" required name="logistics_category">
				  </div>
