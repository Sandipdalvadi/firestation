 <!-- Content Wrapper. Contains page content -->
  ...
  <div class="row">
            ...
            <tbody>
			  ...
			  /*$totalInvoices = mysql_query("SELECT * FROM fuel_quota_allotments WHERE district = '' ORDER BY id DESC");
				   ...
				   $count = 0;
					...
					$sql = "SELECT * FROM fuel_quota_allotments WHERE district IS NULL or district IS NULL  ORDER BY id DESC";
              ...
              <tr>
			   ...
			   <td><a href="<?php echo base_url()?>Quotaallotment/index/<?php echo $row['id']; ?>"><img src="<?php echo base_url()?>assets/img/icon-edit.png" height="20"></a></td>
    ...
    <div class="col-sm-6" style="background-color:#d8e1f0;"><form action="<?php echo base_url()?>Quotaallotment/save" method="post" enctype="multipart/form-data">
