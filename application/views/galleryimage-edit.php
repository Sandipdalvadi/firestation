           ...
           <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">EDIT Gallery Images</li>
                    </ol>
                </section>
							  ...
							  <form role="form" method="post" name="uploadForm" id="uploadForm" enctype='multipart/form-data' >
									...
									?>
										...
										<div class="form-group">
										   ...
										   {
										   ?>
										    <option value="<?php echo $value['id']?>" <?php if($data["category_id"] == $value['id'] ) echo "selected"; ?>><?php echo $value['title']?></option>
										   <?php }
										   ?>
										   ...
										   {
										   ?>
										    <option value="<?php echo $value['id']?>" <?php if($data["sub_category_id"] == $value['id'] ) echo "selected"; ?>><?php echo $value['title']?></option>
										   <?php }
										   ?>
...
$(document).ready(function (e) {
	...
	$("#uploadForm").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
        	url: "<?php echo base_url()?>Galleryimage/update",
			type: "POST",
