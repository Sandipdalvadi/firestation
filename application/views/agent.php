           ...
           <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Internal Agents</li>
                    </ol>
                </section>
                ...
                <section class="content">
								<div >
									<a href="<?php echo base_url()?>Agent/add"><button style="margin:3px;float:left" class="btn btn-success btn-sm">ADD Internal Agents</button></a>
								</div>
                    <div class="row">
					<br><br>
