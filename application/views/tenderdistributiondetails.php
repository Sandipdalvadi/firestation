	      ...
	      <table id="example" class="table table-bordered table-hover display nowrap margin-top-10 table-responsive">
            ...
            <tbody>
              ...
              <tr><form action="" method="post">  <input type="hidden" name="ID" value="<?php echo $row['stock_id']; ?>">
               <td>	<a href="?id=<?php echo $row['id']; ?>&Action=Update"><img src="icon-edit.png" height="40" download></a></td>
              ...
              <td><?php echo $row['qty']; ?></td>  
               <td>	<a href="<?php echo $row['e_tender_copy']; ?>"><img src="documents-icon.png" height="40" download></a></td>
               
               <td>	<a href="<?php echo $row['final_spc_copy']; ?>"><img src="documents-icon.png" height="40" download></a></td>
               
               <td>	<a href="<?php echo $row['supply_order']; ?>"><img src="documents-icon.png" height="40" download></a></td>
                 <td>	<a href="<?php echo $row['lci_report']; ?>"><img src="documents-icon.png" height="40" download></a></td>
               
               
               <td>	<a href="<?php echo $row['sanction_order']; ?>"><img src="documents-icon.png" height="40" download></a></td>
                 <td>	<a href="<?php echo $row['distribution_order']; ?>"><img src="documents-icon.png" height="40" download></a></td>
