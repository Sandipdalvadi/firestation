           ...
           <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">External Agents</li>
                    </ol>
                </section>
                ...
                <section class="content">
								<div >
									<a href="<?php echo base_url()?>Agentexternal/add"><button style="margin:3px;float:left" class="btn btn-success btn-sm">ADD External Agents</button></a>
								</div>
                    <div class="row">
					<br><br>
                                    ...
                                    <table id="example1" class="table table-bordered table-striped">
										...
										?>
                                            <tr>
												...
												<td><a href="<?php echo base_url()?>Agentexternal/edit/<?php echo $row['admin_id'];?>"><button class="btn btn-success btn-sm">Edit</button></a>  
												<a href="<?php echo base_url()?>Agentexternal/status/<?php echo $row['admin_id'];?>" onclick="return confirm('Are you sure want to Delete?')"><button class="btn btn-danger btn-sm">Delete</button>
												</td>
                                            </tr>
                                        <?php }
...
$(document).on("keyup", "#mobile", function () {
	...
	$("#uploadForm").on('submit',(function(e) {
		e.preventDefault();
		$.ajax({
        	url: "<?php echo base_url()?>Agent/SearchAgents",
			type: "POST",
	...
	function search(refobj){
		  var form = document.getElementById('uploadForm');
	  		$.ajax({
        	url: "<?php echo base_url()?>Agentexternal/SearchAgents",
			type: "POST",
