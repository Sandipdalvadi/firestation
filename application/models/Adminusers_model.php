...
class Adminusers_model extends CI_Model {
	...
	public function get_all_users() {        
		...
		$sql = "select a.*,GROUP_CONCAT(b.name ORDER BY b.name) localityname from admin a INNER JOIN lab_locality b ON FIND_IN_SET(b.id, a.locality_id) > 0 AND  a.is_deleted='N' and a.admin_type=3 GROUP   BY a.admin_id  "; //3 means Admin Users
	...
	public function get_all_users_location() {
		...
		//echo $sql;
		$sql = "select a.*,GROUP_CONCAT(b.name ORDER BY b.name) localityname from admin a INNER JOIN lab_locality b ON FIND_IN_SET(b.id, a.locality_id) > 0 AND  a.is_deleted='N' and a.admin_type=3   ";
