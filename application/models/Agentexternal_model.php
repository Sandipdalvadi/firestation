<?php 
class Agentexternal_model extends CI_Model {
	...
	public function get_all_users() {        
		...
		$sql = "select a.*,GROUP_CONCAT(b.name ORDER BY b.name) localityname from admin a INNER JOIN lab_locality b ON FIND_IN_SET(b.id, a.locality_id) > 0 AND  a.is_deleted='N' and a.admin_type=4 GROUP   BY a.admin_id  ";
	...
	public function get_all_users_location() {
		...
		//echo $sql;
		$sql = "select a.*,GROUP_CONCAT(b.name ORDER BY b.name) localityname from admin a INNER JOIN lab_locality b ON FIND_IN_SET(b.id, a.locality_id) > 0 AND  a.is_deleted='N' and a.admin_type=4   ";
