...
class Country_model extends CI_Model {
	...
	public function checkExists($name) {       
	   return $this->db->select("*")->from("lab_country")->where("name", $name)->where("is_deleted", 'N')->get()->num_rows();
    }
	public function checkExistsEdit($name,$id) {       
	   return $this->db->select("*")->from("lab_country")->where("id !=" ,$id)->where("name", $name)->where("is_deleted", 'N')->get()->num_rows();
    }
