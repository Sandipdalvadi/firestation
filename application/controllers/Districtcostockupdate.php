...
class Districtcostockupdate extends CI_Controller { 
	...
	public function index($id=0)
	{
		...
		$this->load->view('districtcostockupdate',$data);
	...
	public function save()
	{
		...
		$sql = "UPDATE recivestockbytender_new SET  rv_number = '".$_POST['rv_number']."', rv_date = '".$_POST['rv_date']."', transfer=2, updated_by = '".$_SESSION["name"]."' WHERE stock_id = ".$_POST['ID']."";
		$this->db->query($sql);
