...
class Localrecivestockbytender extends CI_Controller { 
	...
	public function index($id=0)
	{
		...
		$this->load->view('localrecivestockbytender',$data);
	...
	public function delete($id=null)
	{
		 ...
		 redirect('Localrecivestockbytender');
	}
	public function save()
	{
		...
		$insert = $this->db->insert('local_stock_unit',$insertData);
