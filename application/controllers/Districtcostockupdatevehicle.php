...
class Districtcostockupdatevehicle extends CI_Controller { 
	...
	public function index($id=0)
	{
		...
		$this->load->view('Districtcostockupdatevehicle',$data);
	...
	public function save()
	{
		...
		$sql = "UPDATE vehicle_allotment SET  rv_number = '".$_POST['rv_number']."', rv_date = '".$_POST['rv_date']."' WHERE allotment_id = ".$_POST['ID']."";
		$this->db->query($sql);
...
redirect('Districtcostockupdatevehicle');die;
