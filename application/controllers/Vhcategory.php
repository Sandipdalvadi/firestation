...
class Vhcategory extends CI_Controller { 
	...
	public function index()
	{
		...
		$this->load->view('vhcategory',$data);
	...
	{
		 $sql = "DELETE FROM vehicle_category_masters  WHERE  id = '".$id."'";
		  $this->db->query($sql);
	...
	public function save()
	{
		...
		$insert = $this->db->insert('vehicle_category_masters',$insertData);
