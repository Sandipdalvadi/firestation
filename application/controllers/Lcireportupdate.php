...
class Lcireportupdate extends CI_Controller { 
	...
	public function index()
	{
		...
		//$this->load->view('lcireportupdate',$data);
		$this->load->view('lciupdate-new',$data);
		...
		public function index2()
	{
		...
		/*print("<pre>");
		print_r($data["fetch222"]);
		die;
		*/
		
		$this->load->view('lciupdater-new2',$data);
		$this->load->view('includes/footer',$data);
...
lci_officer_3='".$_POST['lci_officer_3']."',
 head_of_account='".$_POST['head_of_account']."',purpose='".$_POST['purpose']."',purchase_from='".$_POST['purchase_from']."', status ='line committee inspected' where id  ='".$_POST['hidid']."'";
 //
$this->db->query($sql_update);



 $this->session->set_flashdata('message', '<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h4><i class="icon fa fa-check"></i><b>LCI Report Updated Successfully !</b></h4></div>');
redirect('Lcireportupdate');die;
