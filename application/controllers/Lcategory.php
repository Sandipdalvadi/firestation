...
class Lcategory extends CI_Controller { 
	...
	{
		 $sql = "DELETE FROM logistics_category_masters  WHERE  id = '".$id."'";
		  $this->db->query($sql);
	...
	public function save()
	{
		...
		$insert = $this->db->insert('logistics_category_masters',$insertData);
