...
class Vhvarient extends CI_Controller { 
	...
	{
		 $sql = "DELETE FROM vehicle_variant_masters  WHERE  id = '".$id."'";
		  $this->db->query($sql);
	...
	public function save()
	{
		...
		$insertData  = array(	 				 
					 ...
					 'vehicle_type_masters_id' => $_POST['vehicle_type_masters_id'],
					 'status' => 1
					);
					
		$insert = $this->db->insert('vehicle_variant_masters',$insertData);
