...
class Exitingvhlists extends CI_Controller { 
	...
	public function index($id=0)
	{
		...
		$this->load->view('exitingvhlists',$data);
	...
	public function save()
	{
		...
		$insertData["local_entry_unit_id"] = $_POST['district_unit'];//;//$this->session->userdata('unit');
