...
class Fscostockupdatevehicle extends CI_Controller { 
	...
	public function index($id=0)
	{
		...
		$this->load->view('Fscostockupdatevehicle',$data);
	...
	public function delete($id=null)
	{
		 ...
		 redirect('Districtcostockupdate');
	}
	public function save()
	{
		...
		$sql = "UPDATE vehicle_allotment SET  rv_number_fs = '".$_POST['rv_number']."', rv_date_fs = '".$_POST['rv_date']."', fs_status =1  WHERE allotment_id = ".$_POST['ID']."";
		$this->db->query($sql);
...
redirect('Fscostockupdatevehicle');die;
