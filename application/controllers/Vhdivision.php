...
class Vhdivision extends CI_Controller { 
	...
	public function index()
	{
		...
		$this->load->view('vhdivisions',$data);
	...
	{
		 $sql = "DELETE FROM divisions_masters  WHERE  id = '".$id."'";
		  $this->db->query($sql);
	...
	public function save()
	{
		...
		{
		$insertData  = array(	 				 
                     'divisions_name' => $_POST['divisions_name'],
					 'status' => 1
					);
					
		$insert = $this->db->insert('divisions_masters',$insertData);
