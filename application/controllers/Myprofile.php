...
$sql_update = "UPDATE users SET password = '".$_POST['new_password']."' WHERE name = '".$_SESSION['name']."' ";

$this->db->query($sql_update);



 $this->session->set_flashdata('message', '<div class="alert alert-success alert-dismissible"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button><h4><i class="icon fa fa-check"></i><b>Password Changed  Successfully !</b></h4></div>');
redirect('MyProfile');
