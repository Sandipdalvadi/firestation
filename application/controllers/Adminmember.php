...
if(($this->session->userdata('loginUser')!=''))
		{
			...
			$sql = "select * from lab_permissions where module=2 and role='".$this->session->userdata('loginType')."'";
	...
	public function index()
	{
		...
		$data["country"]= $this->Staff_model->get_all_countries3();
		//var_dump($data["country"]);die;
		
		
		if($this->permissions['view'] == 1 )
		{
		$this->load->view('adminmem',$data);
		}
		else{
	...
	public function edit($id=null)
	{
		...
		//$this->load->view('adminmem-edit',$data);
